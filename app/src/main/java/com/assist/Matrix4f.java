...
public class Matrix4f {
	...
	/**
	 * 设置4*4矩阵的一致性，也就是行列坐标一样的时候值为1，否则值为0
	 */
	...
	public final void rotY(float angle) {
		...
		this.m00 = cosAngle;	// c 0 s 0
		this.m01 = 0;			// 0 1 0 0
		this.m02 = sinAngle;	//-s 0 c 0
		this.m03 = 0;			// 0 0 0 1
	...
	public final void rotZ(float angle) {
		...
		this.m00 = cosAngle;	// c -s 0 0
		this.m01 = -sinAngle;	// s c 0 0
		this.m02 = 0;			// 0 0 1 0
		this.m03 = 0;			// 0 0 0 1
	...
	public final void invTransformRotate(Vector3f normal, Vector3f normalOut) {
		float x, y;
		x = normal.x * m00 + normal.y * m10 + normal.z * m20;
		y = normal.x * m01 + normal.y * m11 + normal.z * m21;
		normalOut.z = normal.x * m02 + normal.y * m12 + normal.z * m22;
		normalOut.x = x;
		normalOut.y = y;
	}
	 ...
	 * 
	 * @param fovy 类似于眼睛睁开的角度，即视角的大小，0相当与闭眼 180相当与视界很开阔
	 * @param aspect 实际窗口的纵横比
	 * @param zNear 表示近处的截面
	 * @param zFar 表示远处的截面
	 * @param out 计算结果返回
	 */
